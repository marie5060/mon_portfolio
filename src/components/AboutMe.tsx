...
const AboutMe = () => {
  ...
  const presentation: string = `En reconversion professionnelle, j'ai suivi une formation de développeuse Web et Web Mobile, ainsi qu'une formation PHP/Symfony au sein de la Wild Code School d'Anglet, après un stage de 6 mois chez Digital Copilot. Enthousiaste, volontaire et aimant le travail d'équipe, je suis à la recherche d'une alternance à compter du début mars 2023, afin d'approfondir mes enseignements et d'avancer main dans la main avec ma future entreprise.`;
